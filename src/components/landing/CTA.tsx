        ...
        <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
            ...
            <div className="container relative z-10 text-center">
                ...
                <button
                    ...
                    className="inline-flex items-center gap-3 bg-gradient-to-r from-cyan-400 to-teal-400 hover:from-cyan-300 hover:to-teal-300 text-slate-900 px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:shadow-cyan-400/20 hover:-translate-y-1 transition-all duration-300"
                >
