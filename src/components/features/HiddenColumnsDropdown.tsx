    ...
    return (
        <div className="relative">
            <button
                ...
                className="px-3 py-1.5 text-xs bg-cyan-50 text-cyan-700 border border-cyan-200 rounded-lg hover:bg-cyan-100 flex items-center gap-1"
            >
                    ...
                    <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg border border-gray-200 z-20 min-w-[200px]">
                        ...
                        {hiddenColumns.map(({ header, index }) => (
                            <button
                                ...
                                title={`Show column: ${header || `Column ${index + 1}`}`}
